...
[![Tests](https://img.shields.io/badge/tests-158-blue)](tests/)
...
| Suite | 101 Python tests and 57 hook checks, green in CI on Linux, Windows and macOS, against Python 3.9 and 3.13 |
